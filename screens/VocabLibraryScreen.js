...
export default function VocabLibraryScreen({ route, navigation }) {
  ...
  const selectedLanguage = route?.params?.language || ctxLanguage || 'kannada';
  ...
  useFocusEffect(
    ...
    }, [route?.params?.language, selectedLanguage, searchQuery, masteryFilter, wordClassFilter, levelFilter, language])
  );
